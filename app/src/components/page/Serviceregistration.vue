    ...
    <el-container>
      <el-aside width="200px">
        <div class="sidebar">
          <el-menu>
          <el-menu-item >
                <el-button style="float: right; padding: 25px " type="text" @click="createLabel">+新建标签</el-button>
              </el-menu-item>
          </el-menu>
<el-tree
      :data="labels"
        ...
        <el-form>
          <el-form-item>
              <el-row type="flex">
                  ...
                  <el-col :span="6">
                      <div class="add">
                          <el-button label="right" @click="addService" size="medium">新增</el-button>
                      </div>
                  </el-col>
              </el-row>
          </el-form-item>
            ...
            <el-table :data="models" :show-header="false" :fit="true">
              ...
              <el-table-column min-width="140px">
                <template slot-scope="scope">
                  ...
                  <div
                    class="subit"
                  >上传者：{{scope.row.designer}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 发布时间：{{scope.row.createTime.substring(0,10)}}</div>
                </template>
              </el-table-column>
            </el-table>
            <div>
